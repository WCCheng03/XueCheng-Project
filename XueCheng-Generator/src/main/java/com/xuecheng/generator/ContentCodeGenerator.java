...
public class ContentCodeGenerator {
    ...
    //数据库密码
    private static final String DATA_SOURCE_PASSWORD = "Wwc050619";
    //生成的表
...
//			"mq_message_history"
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://172.30.85.69:3306/xc_" + SERVICE_NAME
                + "?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
//		dsc.setUrl("jdbc:mysql://172.30.85.69:3306/xc_content?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
